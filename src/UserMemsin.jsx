        ...
        <div className="col-lg-4 p-4">
          <div className="d-flex flex-column">
            ...
            <div className="d-flex flex-column usermemsin-1stcol-status-div gap-2">
              ...
              <span className="usermemsin-1stcol-field-text">Active</span>
            </div>
                ...
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="d-flex flex-column gap-4 usermensin-2nd-col-contact-field-span">
                      ...
                      <span>{singleMatData.native_place}</span>
                      <span>{singleMatData.district}</span>
                      <span>{singleMatData.kula_deivam}</span>
                      <span>{singleMatData.temple_place}</span>
                      <span>
                        {new Date(
            ...
            >
              <Panel header="Career & Job Detail" key="1">
                <div className="row">
                  ...
                  <div className="col-8">
                    <div className="d-flex flex-column gap-4 usermensin-2nd-col-contact-field-span">
                      <span>{singleMatData.qualification}</span>
                      <span>{singleMatData.job_designation}</span>
                      {/* <span>
                ...
                <Panel header="Children" key="1">
                  {singleMatData.children.map((child, index) => (
                    <div className="row" key={index}>
                      <div className="usermemsin-children-title d-flex justify-content-center align-items-center">
                      ...
                      <div className="col-8">
                        <div className="d-flex flex-column gap-4 usermensin-2nd-col-contact-field-span">
                          ...
                          <span>{child.relation ? child.relation : "-"}</span>
                        </div>
                      </div>
                    </div>
                  ))}
